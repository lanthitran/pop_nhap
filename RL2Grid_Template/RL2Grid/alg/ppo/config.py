...
def get_alg_args():
    ...
    parser.add_argument('--actor-layers', nargs='+', type=int, default=[512, 256, 256], help='Actor network size')
    ...
    parser.add_argument("--n-minibatches", type=int, default=1563, help="Number of minibatches")
