...
from env.utils import make_env_with_L2RPNReward, make_env_TOPOLOGY_with_L2RPNReward, make_env_TOPOLOGY_IDLE_BSLINE, make_env_TOPOLOGY_IDLE_BSLINE_TRULY
...
def main(args):
    ...
    envs = gym.vector.AsyncVectorEnv([make_env_TOPOLOGY_IDLE_BSLINE_TRULY(args, i, resume_run=checkpoint.resumed, params=grid_params) for i in range(args.n_envs)])
