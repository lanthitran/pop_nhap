...
from env.utils import make_env_with_L2RPNReward, make_env_TOPOLOGY_with_L2RPNReward, make_env_TOPOLOGY_IDLE_Heuristic_with_L2RPNReward
...
def main(args):
    ...
    if checkpoint.resumed: 
        ...
        if args.additional_timesteps > 0:
            ...
            args.total_timesteps += args.additional_timesteps * 3
    ...
    envs = gym.vector.AsyncVectorEnv([make_env_TOPOLOGY_IDLE_Heuristic_with_L2RPNReward(args, i, resume_run=checkpoint.resumed, params=grid_params) for i in range(args.n_envs)])
