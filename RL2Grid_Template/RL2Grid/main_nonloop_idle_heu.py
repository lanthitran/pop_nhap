...
from env.utils import make_env, make_env_with_L2RPNReward, make_env_non_loop_idle_heuristic
...
def main(args):
    ...
    envs = gym.vector.AsyncVectorEnv([make_env_non_loop_idle_heuristic(args, i, resume_run=checkpoint.resumed, params=grid_params) for i in range(args.n_envs)])
