...
from env.utils import make_env_with_L2RPNReward, make_env_TOPOLOGY_with_L2RPNReward
...
def main(args):
    ...
    envs = gym.vector.AsyncVectorEnv([make_env_TOPOLOGY_with_L2RPNReward(args, i, resume_run=checkpoint.resumed, params=grid_params) for i in range(args.n_envs)])
