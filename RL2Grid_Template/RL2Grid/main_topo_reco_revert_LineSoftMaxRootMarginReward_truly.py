...
from env.utils import (
    ...
    make_env_TOPOLOGY_IDLE_RecoAndRevert_LineSoftMaxRootMarginReward
)
...
def main(args):
    ...
    envs = gym.vector.AsyncVectorEnv([make_env_TOPOLOGY_IDLE_RecoAndRevert_LineSoftMaxRootMarginReward(args, i, resume_run=checkpoint.resumed, params=grid_params) for i in range(args.n_envs)])
